...
#       private_key = file("~/.ssh/my_key")             # Path to private key
#      host        = self.public_ip
#      timeout     = "2m"
#    }
...
resource "null_resource" "run_script" {
  provisioner "remote-exec" {
    ...
    inline = [
      "echo 'hello from multicloud with veers' > /home/ubuntu/file200",
      "mkdir -p /home/ubuntu/file",
      "echo 'hello veera and naresh IT' >> /home/ubuntu/file/file500"
